                        ...
                        <div className='p-4'>
                            ...
                            <div className='p-4 bg-white border-1 border-[#321313] rounded-md mt-0'>
                                ...
                                <div className="flex justify-end w-full mb-4 sm:mb-4 mt-8">
                                    <button type="submit" className="text-white bg-[#F4991A] hover:bg-[#f6aa40] focus:ring-4 focus:outline-none focus:ring-[#facc8d] font-bold rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">
                                        Confirm
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className='p-4 bg-white border-1 rounded-md w-4/5 mt-0 border-[#321313]'>
                                <table id="productTable" className='w-full'>
                                    ...
                                    <tr className='p-10 mt-10 font-bold'>
                                        ...
                                        <td className='p-4 text-left' id="totalPrice">0</td>
                                    </tr>
                                </tfoot>
